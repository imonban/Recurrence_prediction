...
###Naive MODEL (tfidf, one note, xgboost)
...
###  Word2Vec Model (one note, xgboost)
vec = np.load("data/OncoShare/xDataset.npy") # generated by OncoShare_CleanData.py
processedNotes = pd.read_csv("data/OncoShare/SupervisedDataset.csv", lineterminator='\n')
